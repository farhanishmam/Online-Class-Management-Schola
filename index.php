...
<head>
  ...
  <link rel="stylesheet" href="assets/animatecss/animate_mobirise.css">
  ...
  #header11-r{  background-color: #EFF3FF ;}
  #features1-m{  background-color: #EFF3FF ;}
  #team1-n{  background-color: #EFF3FF ;}
  #footer3-i{  background-color:  #232323 ;}
...
<body>
    ...
    <section class="header11 cid-siTLs9fTWV mbr-fullscreen" id="header11-r">
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-12 col-md-6 image-wrapper " >
                    <img class="w-100" src="assets/images/scd.svg" >
                </div>
                <div class="col-12 col-md">
                    <div class="text-wrapper text-center">
                        <h1 class="mbr-section-title mbr-fonts-style mb-3 display-2"><strong>SCHOLA
                            </strong></h1>
                        <p class="mbr-text mbr-fonts-style display-7">
                            Web system developed for managing online classes</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="features1 cid-si8a3W2Iwn" id="features1-m">
            ...
            <div class="row">
                    ...
                    <div class="card-wrapper">
                        <div class="card-box align-center">
                            <div class="iconfont-wrapper">
                                <span class="mbr-iconfont mobi-mbri-contact-form mobi-mbri" style="color: rgb(111, 14, 144); fill: rgb(111, 14, 144);"></span>
                            </div>
                            <h5 class="card-title mbr-fonts-style display-7"><strong>To-Do List</strong></h5>
                ...
                <div class="card col-12 col-md-6 col-lg-3">
                    <div class="card-wrapper">
                        <div class="card-box align-center">
                            <div class="iconfont-wrapper">
                                <span class="mbr-iconfont mobi-mbri-calendar mobi-mbri" style="color: rgb(111, 14, 144); fill: rgb(111, 14, 144);"></span>
                            </div>
                            <h5 class="card-title mbr-fonts-style display-7"><strong>Routine</strong></h5>
                ...
                <div class="card col-12 col-md-6 col-lg-3">
                    <div class="card-wrapper">
                        <div class="card-box align-center">
                            <div class="iconfont-wrapper">
                                <span class="mbr-iconfont mbrib-alert" style="color: rgb(111, 14, 144); fill: rgb(111, 14, 144);"></span>
                            </div>
                            <h5 class="card-title mbr-fonts-style display-7"><strong>Notices</strong></h5>
                ...
                <div class="card col-12 col-md-6 col-lg-3">
                    <div class="card-wrapper">
                        <div class="card-box align-center">
                            <div class="iconfont-wrapper">
                                <span class="mbr-iconfont mobi-mbri-users mobi-mbri" style="color: rgb(111, 14, 144); fill: rgb(111, 14, 144);"></span>
                            </div>
                            <h5 class="card-title mbr-fonts-style display-7"><strong>Evaluation Sheet</strong></h5>
    ...
    <section class="team1 cid-si8a9dEzog" id="team1-n">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="card-wrap">
                        <div class="image-wrap">
                            <img src = "assets/images/Tasnim.png">
                        </div>
                        <div class="content-wrap">
                            <h5 class="mbr-section-title card-title mbr-fonts-style align-center m-0 display-7"><strong>Tasnim Ferdous Anan</strong></h5>                       
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="card-wrap">
                        ...
                        <div class="content-wrap">
                            <h5 class="mbr-section-title card-title mbr-fonts-style align-center m-0 display-7"><strong>Farhan Ishmam</strong></h5> 
                        </div>
                    </div>
                </div>
            </div>
    ...
    <a href="https://mobirise.site/r" style="color:#aaa;"></a> </p>
