...
function listDept() {
  db.collection('Department').get().then(function (snapshot) {
    var html = "";
    ...
    snapData.forEach(function (doc) {
      ...
      html += "\n                <tr>\n                    <td class=\"roomcolumn1\">".concat(code, "</td>\n                    <td class=\"roomcolumn2\">").concat(shortForm, "</td>\n                    <td class=\"roomcolumn3\">").concat(fullForm, "</td>\n                    <td class=\"roomcolumn4\">").concat(faculty, "</td>\n                    <td class=\"roomcolumn5\">").concat(estYear, "</td>\n                    <td class=\"roomcolumn6\">\n                        <span value = \"").concat(doc.id, "\" class = \"delete\"> X </span>\n                    </td>\n                </tr>");
    });
